...
public class MainActivity extends AppCompatActivity implements GLSurfaceView.Renderer {
      ...
      if (anchor == null
        ...
        for (HitResult hit : currentFrame.hitTest(queuedSingleTap)) {
          if (shouldCreateAnchorWithHit(hit)) {
            ...
            //add some UI to show you the anchor is being hosted.
  ...
  protected void onResume() {
    ...
    if (session == null) {
      ...
      config.setCloudAnchorMode(Config.CloudAnchorMode.ENABLED);//add this line to enable cloud anchor mode.
  ...
  public void onDrawFrame(GL10 gl) {
    ...
    try {
      ...
      checkUpdatedAnchor(); //invoke this new method.
